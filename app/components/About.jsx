                    ...
                    <ul className='grid grid-cols-1 lg:grid-cols-4 gap-6 max-w-2xl'>
                        {infoList.map(({ icon, iconDark, title, description }, index) => (
                            ...
                            <li key="achievements"
                              ...
                              dark:hover:bg-darkHover/50
                                  '>
                                <Image src={isDarkMode ? '/images/achievement-dark.svg' : '/images/achievement-light.svg'} alt='Achievements icon' className='w-7 mt-3'></Image>
                                <h3 className='my-4 font-semibold text-gray-700 dark:text-white'>Achievements</h3>
                                <p className='text-gray-600 text-sm dark:text-white/80'> Showcase your accomplishments and milestones, celebrating your journey and impact.</p>
                            </li>
                    </ul>
