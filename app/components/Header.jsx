...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4' id='top'>
      ...
      >
        <Image src={assets.profile_img} alt='profile imgage' className='rounded-full w-32' />
      </motion.div>
      ...
      >
        I am a Full-Stack Web Developer and a Computer Science Engineering student at Sir Visvesvaraya Institute of Technology.
      </motion.p>
